...
![作文批改](/img/2_作文批改.png)
  当点击“拍照作文批改”按钮，将进入拍照页面，并开启手机进行拍照，也可点击图册，使用已有的照片进行上传识别。
![拍作文](/img/3_拍作文.png)
...
![图片识别中](/img/6_图片识别中.png)

![输入作文](/img/7_输入作文.png)
  当点击“输入作文批改”按钮，将进入“输入作文”页面，输入作文完成后点击“跳转”按钮。
![作文批改结果](/img/8_作文批改结果.png)
  跳转之后将会出现“作文批改结果”页面，当我们点击按句点评上面的“点击”按钮，即可跳转到“按句点评”页面。
![按句点评](/img/9_按句点评.png)
用户通过作文批改界面，可利用拍照或输入作文来进行上传，从而该App将会对用户的上传的内容进行识别，并返回其相应的作文批改结果给用户，另外还将给用户提供按句点评的功能，让用户更好的学习如何写作文。（利用腾讯云开放平台的英语作文批改API，解决用户“无人批改英语作文”的痛点）
3. 主要页面——翻译和听力训练功能
![翻译](/img/10_翻译.png)
 点击“语音翻译”或“输入文本翻译”，即可跳转到相应页面。
![语音翻译](/img/11_语音翻译.png)

![文本翻译](/img/12_文本翻译.png)
当用户进入翻译页面后，可对翻译方式进行选择，如果选择了“语音翻译”，按住按钮进行语音说话，App将会根据用户所说的语言进行对应的翻译，输出相应的翻译内容。（利用腾讯云开放平台中的机器翻译API，解决“看不懂无字幕美剧”和“不能与外国友人进行快速交流”的痛点）
![听力训练](/img/13_听力训练.png)
